...
<div class="topnav" id="myTopnav">
  ...
  <a href="selectCourseCategory.php">Select Course Category</a>
  <a href="selectRating.php">Select Rating</a>
...
<select name="q" onchange="showUser(this.value)">
  <option value="">Select a feedback ID:</option>
  <?php
    $q = $_GET['q'];
    ...
    while($row = mysqli_fetch_array($result)) { 
        echo "<option value=\"".$row['feedbackID']."\">".$row['feedbackID']."</option>";
